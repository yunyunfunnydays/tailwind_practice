<template>
  <div class="fixed top-0 left-0 w-screen h-screen p-5 flex justify-center items-center"
    :class="[showed ? 'opacity-100': 'opacity-0 pointer-events-none',
  ...
  >
    <div class="border-b-2 p-3 flex justify-between items-center">
      ...
      <div class="h-7 w-7 p-1 hover:bg-gray-200 active:scale-90 rounded-md cursor-pointer transition-all" @click="closing()">
